...
#define CONFIG_MMCBOOT_KEY	KEY_BACK
#endif
...
#define CONFIG_MXC_KEYMAPPING \
	{	\
		KEY_HOME, KEY_MENU, KEY_BACK, KEY_VOLUMEDOWN, KEY_VOLUMEUP,		\
		KEY_0, \
	}
...
#define CONFIG_ANDROID_MMCUP_UBOOT_IMAGE_PREFIX "imx51_aster7"
#endif
...
#define CONFIG_SYS_PROMPT		"ASTER7 U-Boot > "
